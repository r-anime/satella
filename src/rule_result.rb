...
# RuleResult
# rule_module: BaseRule+
# reddit_kind: RedditKind
# actions: [BaseAction+]

# RedditKind (enum)
# post | comment | mod_action
...
# ActionLevel (enum)
# level: remove | report | mod_comment | comment | reflair | custom_action | no_action
# priority: int probs want to spread out

# RemoveAction
# level: ActionLevel::Remove
# comment_templates: [str]
# sticky?: bool

# ReportAction
# level: ActionLevel::Report
# report_template: str

# ModCommentAction
# level: ActionLevel::ModComment
# comment_templates: [str]
# sticky?: bool #only for posts

# CommentAction
# level: ActionLevel::Comment
# comment_templates: [str]

# ReflairAction
# level: ActionLevel::Reflair
# new_flair: [str] # must be a valid flair (externally checked, maybe can have alerting?)

# CustomAction
# level: ActionLevel::Custom
# arguments: obj

# NoAction
# level: ActionLevel::Nothing
